            ...
            <div className="newsletter-l">
              ...
              <form className="newsletter-form">
                <div className="form-group flex items-stretch">
                  ...
                  />
                  <button type="submit" className="btn btn-primary nowrap">
                    Get Started
                  </button>
                </div>
                <p className="text text-base text-gray">
                  Get a response tomorrow if you submit by 9pm today. If we
                  received after 9pm will get a response the following data.
                </p>
              </form>
            </div>
                ...
                <div className="newsletter-info-wrapper bg-white">
                  ...
                  <div className="info-text">
                    ...
                    <p className="text text-lg">
                      Our insurnace plans offers are priced the same everywheres
                      else.
                    </p>
                  </div>
                </div>
